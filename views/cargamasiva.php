...
<div class="content">
    <div class="container-fluid">
        <!-- Fila para cargar el archivo -->
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Seleccionar un archivo de Excel</h3>
        ...
        <div class="row mx-0">
            <div class="col-lg-12 mx-0 text-center">
                <img src="views/assets/imagenes/loading.gif" id="img_carga" style="display:none;">
            </div>
        </div>
    </div><!-- /.container-fluid -->
</div>
...
<script>
    $(document).ready(function(){
        ...
        $("#form_carga_productos").on('submit',function(e){
            ...
            //Validamos la seleccion de un archivo
            if($("#fileProductos").get(0).files.length == 0){
                ...
                //Validamos que el archivo sea de tipo excel
